...
<!-- Tier split is summed from the 12 per-collection headings in
     MATHEMATICAL_ACCURACY.md — keep the two in step (129 + 39 + 24 = 192). -->
> **168 of 192 formulas at verifiable accuracy. Open tests.**
>
> 129 closed-form expressions at IEEE 754 double precision (~10⁻¹⁴).
> 39 validated approximations with bounded error ≤ 10⁻³ to 10⁻⁷.
...
|------|-------|---------------|
| 🟢 A | 129 | IEEE 754 double precision — machine accuracy |
| 🔵 B | 39  | Bounded approximation, error ≤ 10⁻³ to 10⁻⁷ |
