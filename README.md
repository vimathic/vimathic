...
<!-- Tier split is summed from the 12 per-collection headings in
     MATHEMATICAL_ACCURACY.md — keep the two in step (127 + 34 + 31 = 192). -->
> **161 of 192 formulas at verifiable accuracy. Open tests.**
>
> 127 closed-form expressions at IEEE 754 double precision (~10⁻¹⁴).
> 34 validated approximations with bounded error ≤ 10⁻³ to 10⁻⁷.
...
|------|-------|---------------|
| 🟢 A | 127 | IEEE 754 double precision — machine accuracy |
| 🔵 B | 34 | Bounded approximation, error ≤ 10⁻³ to 10⁻⁷ |
