...
- The photosensitivity warning above applies equally to **recorded clips**.
  A flashing scene recorded through the GIF recorder is just as capable of
  triggering a seizure as the live render. If you share recordings, consider
  including a brief flashing-content warning.
...
**Read the photosensitivity warning. Verify what matters. Use at your own risk.**
